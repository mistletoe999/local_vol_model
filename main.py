...
if __name__ == '__main__':
    ...
    #    '../data_graphs/yield_forward_curve.pdf')
    #dividend_curve.inst_forward_rate_plot(time_to_maturities, 
    #    'time-to-maturity', 'instantaneous forward rate', 
    #    '../data_graphs/dividend_forward_curve.pdf')
    ...
    #    'variance swap rate', '../data_graphs/var_swap_curve.pdf')
    ...
    strikes = np.linspace(1700.0, 2500.0, 17)
    ...
    #    '../data_graphs/spx_vol_surface.pdf')
    ...
    dynamic_local_vol = volatility.DynamicLocalVolSurface(
        ...
        months = 8, grids_per_month = 1, deltax_per_month = 0.2)
    ...
    filename = "../data_graphs/mse.txt"
    # Find the global minimum of MSE
    # for c in [ 0.0015, 0.00152 ]:
    #     for a in [ 20.0, 21.0, 22.0, 23.0, 24.0, 25.0, 26.0,  ]:
    #         for b in [ -0.2, -0.1, 0.0, 0.1, 0.2 ]:
 
    # for c in [ 0.0015, 0.00152 ]:
    #     for a in [ 21.0, 21.5, 22.0, 22.5, 23.0 ]:
    #         for b in [ -1.0, -0.8, -0.6, -0.5, -0.4, -0.3  ]:  

    # for c in [ 0.0015, 0.00152 ]:
    #     for a in [ 20.0, 20.5, 21.0, 21.5, 22.0 ]:
    #         for b in [ -0.7, -0.6, -0.5  ]:   

    # for c in [ 0.0015 ]:
    #     for a in [ 20.5, 20.6, 20.7, 20.8, 20.9, 21.0  ]:
    #         for b in [ -0.75, -0.74, -0.73, -0.72, -0.71, -0.7 ]:          
    #                 paras = {"a" : a, "b" : b, "c" : c} 
    ...
    #                 file.write(''.join(str((a, b, c, MSE))) + '\n')
    #                 file.close()



    # Calculte the model prices of VIX options for give parameters
    paras = {"a" : 20.7, "b" : -0.74, "c" : 0.0015} 
    dynamic_local_vol.cal_dynamic_vix(paras)
    calibrate.cal_vix_options(vix_option_data, dynamic_local_vol)
    ...
    MSE = calibrate.cal_implied_vol(vix, vix_option_data)
 	...
 	# Plot the implied volatility skews
